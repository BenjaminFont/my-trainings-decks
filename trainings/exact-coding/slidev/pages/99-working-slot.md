...
<li>Pick one of your own repos</li>
<li>Create a branch: <code class="inline">test-driven-development</code></li>
<li>From the provided repo <strong>test-driven-development-files</strong>, copy the <code class="inline">.claude</code> folder into your repo</li>
</ul>
</div>
<div>
<div class="ws-phase"><span class="pill blue">Phase 2 · Plenum</span> Pick a feature</div>
<ul class="dot-list compact">
<li>Think of a <strong>small</strong> feature — not trivial (no renaming, no just-adding-tests), but not ultra-complex either</li>
<li>Big enough to run the full workflow with the agent once</li>
<li>Ideally with a frontend &amp; backend part (not required)</li>
<li>Note your plan → discuss in the <strong>plenum</strong></li>
</ul>
<div class="ws-phase" style="margin-top:0.6em"><span class="pill green">Phase 3</span> Implement</div>
<ul class="dot-list compact">
<li>Build the feature following <strong>Test-Driven Development</strong></li>
<li>Red → Green → Refactor with the agent</li>
</ul>
</div>
</div>
