...
<ChapterMark secno="06" tag="Schlank per Default · 🛠" />
...
<Pipeline :steps="['Grüne Karten','Gherkin','binden','grün','Drift']" />
...
<div style="margin-top:0.8em"><Verdict state="red" label="strict" /></div>
...
<div class="flow" style="margin-top:0.7em;justify-content:center">
  <Verdict state="green" /><span class="arrow">→</span>
