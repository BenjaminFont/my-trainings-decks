...
<span class="secno">02</span>
<h2 class="slash">MCP-Empfehlungen für Kunde</h2>

<div class="Kunde-table">

| Tier | MCP-Server | Nutzen für Kunde | Track |
|---|---|---|---|
...
<!--
Folie für Kunde (AI Enablement Sprint, Kickoff 15./16.06., Review 03.07.2026).
Quelle: kunden/Kunde/mcp-empfehlungen.md.
Ziel: Konkrete MCP-Server an den Kunde-Stack andocken — von der generischen MCP-Theorie zum „was richten WIR ein".
Was du sagen kannst:
